...
const en = {
  ...
  "chat.title": "Community Global Chat",
  "chat.subtitle": "Ask, share questions and help other students in real time.",
  "chat.serverTr": "🇹🇷 Türkçe Sunucusu",
  "chat.serverEn": "🇬🇧 English / Global Server",
  "chat.online": "{n} online",
  "chat.members": "{n} members",
  "chat.placeholder": "Write a message… type @ to mention someone",
  "chat.send": "Send",
  "chat.shareQuestion": "Share question",
  "chat.shareTitle": "Share a question from your vault",
  "chat.shareEmpty": "Your vault is empty — add a mistake first.",
  "chat.attached": "Attached question",
  "chat.remove": "Remove",
  "chat.questionCard": "Shared question",
  "chat.openInVault": "Open in vault",
  "chat.practiceThis": "Practice this",
  "chat.reply": "Reply",
  "chat.replyingTo": "Replying to {name}",
  "chat.cancelReply": "Cancel",
  "chat.report": "Report message",
  "chat.reportToast": "Message reported",
  "chat.reportToastDesc": "Thanks — our moderators will review it shortly.",
  "chat.actions": "Message actions",
  "chat.longPressHint": "Tip: long-press a message (or right-click) to reply or report it.",
  "chat.you": "You",
  "chat.mentionToast": "🔔 {name} mentioned you in a comment: “{text}”",
  "chat.mentionTitle": "New mention",
  "chat.sentMention": "Mention sent to {name}",
  "chat.level": "Lvl",
  "chat.now": "now",
  "chat.minutesAgo": "{n}m ago",
  "chat.typing": "{name} is typing…",
  "chat.mentionPickerEmpty": "No member found",

  "nav.exam": "Exam",
  "exam.title": "AI Exam Simulator",
  "exam.subtitle": "A custom 10-question mock exam, generated from your topic or your vault.",
  "exam.setupTitle": "Exam setup",
  "exam.topicLabel": "Topic or focus",
  "exam.topicPlaceholder": "e.g. Kinematics, Logarithms, Genetics…",
  "exam.sourceLabel": "Question source",
  "exam.sourceTopic": "Topic (AI generated)",
  "exam.sourceVault": "My mistake vault",
  "exam.sourceMixed": "Mixed",
  "exam.durationLabel": "Exam duration",
  "exam.minutes": "{n} min",
  "exam.start": "Generate & start exam",
  "exam.generating": "AI is building your exam…",
  "exam.generatingDesc": "Analysing the topic, picking 10 questions and calibrating difficulty.",
  "exam.needTopic": "Enter a topic or pick your vault as the source.",
  "exam.questionN": "Question {i} of {n}",
  ...
  "exam.prev": "Previous",
  "exam.next": "Next",
  "exam.clear": "Leave blank",
  "exam.finish": "Finish exam",
  "exam.finishTitle": "Finish the exam?",
  "exam.finishDesc": "You have {answered} answered and {blank} blank questions. You can't change answers afterwards.",
  "exam.cancel": "Keep going",
  "exam.confirmFinish": "Yes, finish",
  "exam.timeUpTitle": "Time is up!",
  "exam.timeUpDesc": "Your exam was submitted automatically.",
  ...
  "exam.blanks": "Blank",
  "exam.timeTaken": "Time taken",
  "exam.breakdown": "Missed questions & AI explanations",
  "exam.perfect": "Flawless run — no missed questions to review. 🎉",
  "exam.yourAnswer": "Your answer",
  "exam.correctAnswer": "Correct answer",
  "exam.noAnswer": "Left blank",
  "exam.explanation": "Step-by-step AI explanation",
  "exam.autoSaved": "{n} missed questions were auto-saved to your Mistake Vault.",
  "exam.autoSavedNone": "Nothing to auto-save — great work!",
  "exam.retake": "New exam",
  "exam.openVault": "Open Mistake Vault",
  "exam.quickAction": "AI Exam Simulator",
  "exam.quickActionDesc": "10-question timed mock exam",

  "exam.vaultCta": "📸 Take AI Exam from Vault / Notes",
  "exam.vaultCtaDesc": "Scan a page of notes or pick your saved questions — the AI writes a timed 10-question test.",
  "exam.materialLabel": "Exam material",
  "exam.materialPhoto": "Photo of notes / textbook",
  "exam.materialVault": "My saved vault questions",
  "exam.materialTopic": "Just a topic",
  "exam.photoPick": "Upload or take a photo",
  "exam.photoAttached": "Photo attached",
  "exam.photoRemove": "Remove photo",
  "exam.needMaterial": "Add a photo, a topic, or save some questions first.",
  "exam.aiError": "The AI could not build the exam. Please try again.",
  "exam.ocrError": "The AI could not read that photo. Try a clearer one.",
  "exam.close": "Close",
  "exam.exit": "Leave exam",
  "exam.savingVault": "Saving missed questions to your vault…",
  "exam.signInHint": "Sign in to save your exam mistakes permanently.",

  "auth.title": "Sign in to QuizForge",
  "auth.subtitle": "Your vault, exams and AI explanations are saved to your account.",
  "auth.email": "Email",
  ...
  "auth.guest": "You are browsing as a guest — sign in to save your vault.",
...
const tr: Record<Key, string> = {
  ...
  "ocr.trigger": "Fotoğraf tara",
  "ocr.title": "Yapay zekâ ile fotoğraftan soru ekle",
  "ocr.sourceDesc": "Sorunun fotoğrafını çek veya yükle — yapay zekâ senin için okusun.",
  "ocr.takePhoto": "Fotoğraf Çek",
  "ocr.takePhotoHint": "Kamerayı açar",
  "ocr.gallery": "Galeriden yükle",
  "ocr.galleryHint": "Var olan bir görseli seç",
  "ocr.dropTitle": "Görseli buraya sürükleyip bırak",
  "ocr.dropHint": "PNG veya JPG, soru ve şıklar tek karede olsun",
  "ocr.dropActive": "Devam etmek için görseli bırak",
  "ocr.errType": "Bu dosya bir görsel değil.",
  "ocr.cropTitle": "Soruyu kırp",
  "ocr.cropDesc": "Köşe tutamaçlarını sürükleyerek soruyu ve şıklarını çerçeveye al.",
  "ocr.rotate": "Döndür",
  "ocr.zoom": "Yakınlaştır",
  "ocr.reset": "Kırpmayı sıfırla",
  "ocr.back": "Geri",
  "ocr.process": "Kırp ve Taramayı Başlat",
  "ocr.scanning": "Yapay zekâ soruyu, şıkları ve dersi tarıyor…",
  "ocr.scanStep1": "Görsel iyileştiriliyor ve metin blokları bulunuyor",
  "ocr.scanStep2": "Soru kökü okunuyor",
  "ocr.scanStep3": "A–E şıkları ayrıştırılıyor",
  "ocr.scanStep4": "Ders ve konu tespit ediliyor",
  "ocr.verifyTitle": "Çıkarılan soruyu kontrol et",
  "ocr.verifyDesc": "Yapay zekânın yanlış okuduğu yerleri düzelt, sonra deftere kaydet.",
  "ocr.questionText": "Soru Metni",
  "ocr.choices": "Şıklar",
  "ocr.correctAnswer": "Doğru cevap",
  "ocr.pickCorrect": "Doğru şıkkı seç",
  "ocr.detected": "Otomatik algılandı",
  "ocr.subject": "Ders",
  "ocr.topic": "Konu",
  "ocr.difficulty": "Zorluk",
  "ocr.notes": "Neden yanlış yaptın?",
  "ocr.rescan": "Yeniden kırp",
  "ocr.save": "Yanlış Defterine Kaydet",
  "ocr.errQuestion": "Soru metni boş olamaz.",
  "ocr.errCorrect": "Hangi şıkkın doğru olduğunu onayla.",
  "ocr.saved": "Taranan soru kaydedildi",
  "ocr.savedDesc": "Yapay zekâ tarafından çıkarıldı ve deftere eklendi.",
  "ocr.confidence": "OCR güveni %{n}",
  ...
  "chat.title": "Topluluk Global Sohbeti",
  "chat.subtitle": "Soru sor, soru paylaş ve diğer öğrencilere anında yardım et.",
  "chat.serverTr": "🇹🇷 Türkçe Sunucusu",
  "chat.serverEn": "🇬🇧 English / Global Server",
  "chat.online": "{n} çevrimiçi",
  "chat.members": "{n} üye",
  "chat.placeholder": "Mesaj yaz… birinden bahsetmek için @ yaz",
  "chat.send": "Gönder",
  "chat.shareQuestion": "Soru Paylaş",
  "chat.shareTitle": "Defterinden bir soru paylaş",
  "chat.shareEmpty": "Defterin boş — önce bir yanlış ekle.",
  "chat.attached": "Eklenen soru",
  "chat.remove": "Kaldır",
  "chat.questionCard": "Paylaşılan soru",
  "chat.openInVault": "Defterde aç",
  "chat.practiceThis": "Bunu çöz",
  "chat.reply": "Yanıtla",
  "chat.replyingTo": "{name} kişisine yanıt veriyorsun",
  "chat.cancelReply": "Vazgeç",
  "chat.report": "Mesajı bildir",
  "chat.reportToast": "Mesaj bildirildi",
  "chat.reportToastDesc": "Teşekkürler — moderatörlerimiz en kısa sürede inceleyecek.",
  "chat.actions": "Mesaj işlemleri",
  "chat.longPressHint": "İpucu: yanıtlamak veya bildirmek için mesaja uzun bas (ya da sağ tıkla).",
  "chat.you": "Sen",
  "chat.mentionToast": "🔔 {name} sana bir yorumda bahsetti: “{text}”",
  "chat.mentionTitle": "Yeni bahsetme",
  "chat.sentMention": "{name} kişisine bildirim gönderildi",
  "chat.level": "Sv",
  "chat.now": "şimdi",
  "chat.minutesAgo": "{n} dk önce",
  "chat.typing": "{name} yazıyor…",
  "chat.mentionPickerEmpty": "Üye bulunamadı",

  "nav.exam": "Sınav",
  "exam.title": "Yapay Zekâ Sınav Simülatörü",
  "exam.subtitle": "Konuna ya da defterine göre hazırlanan 10 soruluk deneme sınavı.",
  "exam.setupTitle": "Sınav ayarları",
  "exam.topicLabel": "Konu veya odak",
  "exam.topicPlaceholder": "örn. Kinematik, Logaritma, Genetik…",
  "exam.sourceLabel": "Soru kaynağı",
  "exam.sourceTopic": "Konu (yapay zekâ üretir)",
  "exam.sourceVault": "Yanlış defterim",
  "exam.sourceMixed": "Karışık",
  "exam.durationLabel": "Sınav süresi",
  "exam.minutes": "{n} dk",
  "exam.start": "Sınavı oluştur ve başlat",
  "exam.generating": "Yapay zekâ sınavını hazırlıyor…",
  "exam.generatingDesc": "Konu analiz ediliyor, 10 soru seçiliyor ve zorluk ayarlanıyor.",
  "exam.needTopic": "Bir konu yaz ya da kaynak olarak defterini seç.",
  "exam.questionN": "Soru {i} / {n}",
  "exam.navigator": "Sorular",
  "exam.answered": "Cevaplanan",
  "exam.blank": "Boş",
  "exam.current": "Şu anki",
  "exam.prev": "Önceki",
  "exam.next": "Sonraki",
  "exam.clear": "Boş bırak",
  "exam.finish": "Sınavı bitir",
  "exam.finishTitle": "Sınav bitirilsin mi?",
  "exam.finishDesc": "{answered} soruyu cevapladın, {blank} soru boş. Sonrasında cevapları değiştiremezsin.",
  "exam.cancel": "Devam et",
  "exam.confirmFinish": "Evet, bitir",
  "exam.timeUpTitle": "Süre doldu!",
  "exam.timeUpDesc": "Sınavın otomatik olarak gönderildi.",
  "exam.resultsTitle": "Sınav sonuçları",
  "exam.score": "Puan",
  "exam.accuracy": "Doğruluk",
  "exam.correct": "Doğru",
  "exam.incorrect": "Yanlış",
  "exam.blanks": "Boş",
  "exam.timeTaken": "Geçen süre",
  "exam.breakdown": "Yanlışlar ve yapay zekâ açıklamaları",
  "exam.perfect": "Kusursuz! İncelenecek yanlış yok. 🎉",
  "exam.yourAnswer": "Senin cevabın",
  "exam.correctAnswer": "Doğru cevap",
  "exam.noAnswer": "Boş bırakıldı",
  "exam.explanation": "Adım adım yapay zekâ açıklaması",
  "exam.autoSaved": "{n} yanlış soru otomatik olarak Yanlış Defteri'ne kaydedildi.",
  "exam.autoSavedNone": "Kaydedilecek yanlış yok — harika iş!",
  "exam.retake": "Yeni sınav",
  "exam.openVault": "Yanlış Defteri'ni aç",
  "exam.quickAction": "Yapay Zekâ Sınav Simülatörü",
  "exam.quickActionDesc": "10 soruluk süreli deneme sınavı",

  "exam.vaultCta": "📸 Defter/Notlardan AI Sınavı Başlat",
  "exam.vaultCtaDesc": "Not sayfanı tara ya da kayıtlı sorularını seç — yapay zekâ 10 soruluk süreli bir test hazırlasın.",
  "exam.materialLabel": "Sınav kaynağı",
  "exam.materialPhoto": "Not / kitap fotoğrafı",
  "exam.materialVault": "Defterimdeki sorular",
  "exam.materialTopic": "Sadece konu",
  "exam.photoPick": "Fotoğraf çek veya yükle",
  "exam.photoAttached": "Fotoğraf eklendi",
  "exam.photoRemove": "Fotoğrafı kaldır",
  "exam.needMaterial": "Bir fotoğraf ya da konu ekle, veya önce defterine soru kaydet.",
  "exam.aiError": "Yapay zekâ sınavı oluşturamadı. Lütfen tekrar dene.",
  "exam.ocrError": "Yapay zekâ bu fotoğrafı okuyamadı. Daha net bir fotoğraf dene.",
  "exam.close": "Kapat",
  "exam.exit": "Sınavdan çık",
  "exam.savingVault": "Yanlışların deftere kaydediliyor…",
  "exam.signInHint": "Sınav yanlışlarının kalıcı kaydedilmesi için giriş yap.",

  "auth.title": "QuizForge'a giriş yap",
  "auth.subtitle": "Defterin, sınavların ve yapay zekâ çözümlerin hesabına kaydedilir.",
  "auth.email": "E-posta",
  "auth.password": "Şifre",
  "auth.signIn": "Giriş yap",
  "auth.signUp": "Hesap oluştur",
  "auth.toSignUp": "Yeni misin? Hesap oluştur",
  "auth.toSignIn": "Hesabın var mı? Giriş yap",
  "auth.google": "Google ile devam et",
  "auth.checkEmail": "E-posta adresini doğrulamak için gelen kutunu kontrol et.",
  "auth.welcome": "Tekrar hoş geldin!",
  "auth.error": "Giriş başarısız",
  "auth.signOut": "Çıkış Yap",
  "auth.signedInAs": "{email} olarak giriş yapıldı",
  "auth.guest": "Misafir olarak geziyorsun — defterini kaydetmek için giriş yap.",
